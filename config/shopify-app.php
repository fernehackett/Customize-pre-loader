...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Custom Pre-loader'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '1b3c6a94629c50a27b6e92991e308beb'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'write_themes'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', env("APP_URL")."/uninstall")
        ],
        /*
            [
